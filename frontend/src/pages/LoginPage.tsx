      ...
      <div className="bg-gray-100 dark:bg-gray-800 p-8 rounded-generous shadow-whisper w-full max-w-md space-y-6">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-accent-500 text-gray-100 py-2.5 rounded-generous hover:bg-accent-600 disabled:opacity-50 font-medium shadow-ring-warm transition-colors"
          >
            {loading ? 'ログイン中...' : 'ログイン'}
          </button>
        </form>
